<template>
  <div>
    <header class="border-y">
      <nav>
        <nuxt-link to=""
          ><span class="desktop-brand hideOnMobile">MOG</span></nuxt-link
        >
        ...
        <ul
          class="sidebar divide-y flex gap-4"
          v-if="open"
        >
          <li class="nav-close">
            <nuxt-link
    ...
    >
      <div class="container px-6 pt-6">
          ...
          <form action="">
            ...
            >
              <div class="md:mb-6 md:ms-auto">
                <p>
                  <span>Get notified when new collections drop:</span>
                </p>
              </div>
        ...
        <div class="mb-6">
          <p>
            Contact us via line, instagram or at the booth held on MUIC building
            ayutathorn during events.
          </p>
        </div>
      </div>
      ...
      <div class="w-full bg-black/5 p-4 text-center">
        <span>Mahidol Original Clothing ( 2024 ) | MOG</span>
      </div>
    </footer>
  </div>
</template>
